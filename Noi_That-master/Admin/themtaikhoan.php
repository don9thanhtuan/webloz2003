...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $mat_khau = md5($_POST['mat_khau']); // Lưu mật khẩu đã mã hóa (khuyến nghị sử dụng phương pháp an toàn hơn)
    //$role = $_POST['role'];
            ...
            <div class="accordion-item">
                <div class="container-fluid bg-secondary">
                    <div class="hstack gap-2 ">
                        <div class="p-2"><h5>Thêm tài khoản<h5></div> 
                    </div>
                </div>
                <div class="accordion-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="repassword" class="form-control" name="mat_khau">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="span10 col-sm-12" style="height:40px; width: 100px;" name="gioi_tinh" id="ProductCategories_status">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" name="dia_chi">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="span10 col-sm-12" style="height:40px; width: 100px;" name="cap_bac" id="ProductCategories_status">
                    ...
                    <div class="control-group form-group buttons">
                        <input class="btn btn-primary" href="quan_ly_danh_muc.php" id="btnAddCate" type="submit" value="Tạo tài khoản" />                    
                    </div>
                    </form>
                </div>
            </div>
